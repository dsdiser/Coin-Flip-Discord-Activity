/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9987da77f20b19b98d56b34d7ed06e4c)
// Runtime types generated with workerd@1.20251011.0 2025-04-03 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/main");
		durableNamespaces: "RoomDO";
	}
	interface Env {
		VITE_DISCORD_CLIENT_ID: string;
		DISCORD_CLIENT_SECRET: string;
		ROOM_DO: DurableObjectNamespace<import("./worker/main").RoomDO>;
	}
}
